...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_users_location', ['latitude', 'longitude'], unique=False)
    ...
    with op.batch_alter_table('matches', schema=None) as batch_op:
        batch_op.create_index('ix_matches_is_active', ['is_active'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('swiper_id', 'target_user_id', name='uq_swipe_pair')
    )
    with op.batch_alter_table('swipes', schema=None) as batch_op:
        batch_op.create_index('ix_swipes_direction', ['direction'], unique=False)
        batch_op.create_index('ix_swipes_swiper', ['swiper_id'], unique=False)
        batch_op.create_index('ix_swipes_target', ['target_user_id'], unique=False)
    ...
    with op.batch_alter_table('user_photos', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_user_photos_user_position', ['user_id', 'position'], unique=False)
    ...
    with op.batch_alter_table('messages', schema=None) as batch_op:
        batch_op.create_index('ix_messages_is_read', ['match_id', 'is_read'], unique=False)
        batch_op.create_index('ix_messages_match_created', ['match_id', 'created_at'], unique=False)
